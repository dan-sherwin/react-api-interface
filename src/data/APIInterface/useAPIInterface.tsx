...
export const apiGet = <T = any>(path: string, queryParams?: { [key: string]: string; }, headers?: { [key: string]: string; }) => defInst.apiGet<T>(path, queryParams, headers);
export const apiDelete = <T = any>(path: string, queryParams?: { [key: string]: string; }, headers?: { [key: string]: string; }) => defInst.apiDelete<T>(path, queryParams, headers);
export const apiPost = <TResp = any, TBody = unknown>(path: string, data?: TBody, queryParams?: { [key: string]: string; }, headers?: { [key: string]: string; }) => defInst.apiPost<TResp, TBody>(path, data, queryParams, headers);
export const apiPostForm = <TResp = any>(path: string, data?: { [key: string]: string | Blob }[], queryParams?: { [key: string]: string; }, headers?: { [key: string]: string; }) => defInst.apiPostForm<TResp>(path, data, queryParams, headers);
export const apiPut = <TResp = any, TBody = unknown>(path: string, data?: TBody, queryParams?: { [key: string]: string; }, headers?: { [key: string]: string; }) => defInst.apiPut<TResp, TBody>(path, data, queryParams, headers);
export const apiPatch = <TResp = any, TBody = unknown>(path: string, data?: TBody, queryParams?: { [key: string]: string; }, headers?: { [key: string]: string; }) => defInst.apiPatch<TResp, TBody>(path, data, queryParams, headers);
...
export const useAPIInterface = (apiBaseURL?: string, authorizationHeader?: string, enableLog?: boolean, apiTimeout?: number, includeCredentials?: boolean, headers?: {[key: string]: string}, requestPreProcessor?: ((apiRequest: IAPIRequest) => IAPIRequest), responsePostProcessor?: ((response: any) => any), errorResponsePostProcessor?: ((response: APIError) => APIError)): Omit<IAPIInterface, "whatAmI"> => {
    ...
    const apiGet = <T = any>(path: string, queryParams?: { [key: string]: string; }, headers?: { [key: string]: string; }) => inst.apiGet<T>(path, queryParams, headers);
    const apiDelete = <T = any>(path: string, queryParams?: { [key: string]: string; }, headers?: { [key: string]: string; }) => inst.apiDelete<T>(path, queryParams, headers);
    const apiPost = <TResp = any, TBody = unknown>(path: string, data?: TBody, queryParams?: { [key: string]: string; }, headers?: { [key: string]: string; }) => inst.apiPost<TResp, TBody>(path, data, queryParams, headers);
    const apiPostForm = <TResp = any>(path: string, data?: { [key: string]: string | Blob }[], queryParams?: { [key: string]: string; }, headers?: { [key: string]: string; }) => inst.apiPostForm<TResp>(path, data, queryParams, headers);
    const apiPut = <TResp = any, TBody = unknown>(path: string, data?: TBody, queryParams?: { [key: string]: string; }, headers?: { [key: string]: string; }) => inst.apiPut<TResp, TBody>(path, data, queryParams, headers);
    const apiPatch = <TResp = any, TBody = unknown>(path: string, data?: TBody, queryParams?: { [key: string]: string; }, headers?: { [key: string]: string; }) => inst.apiPatch<TResp, TBody>(path, data, queryParams, headers);
